...
class TankBattle(object):
    ...
    def __draw_score(self, k=0):
        ...
        stage_text = self.font.render('Loop ' + str(k + 1), False, Utils.get_color(Utils.WHITE))  # modified
    ...
    def reset(self):
        ...
        if self.is_debug:
            ...
            print("Player 2 score:", self.total_score_p2)
            print("#################################################")
            self.points.append(self.total_score_p1)
    ...
    def step(self, action, action_p2=-1):
        ...
        return self.get_state(), self.__check_reward(), self.is_terminal(), 1
